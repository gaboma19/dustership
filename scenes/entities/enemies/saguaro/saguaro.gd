...
func set_stunned(value: bool):
	if value:
		...
		animation_tree.set("parameters/sink/TimeScale/scale", 0)
		animation_tree.set("parameters/rise/TimeScale/scale", 0)
	else:
		animation_tree.set("parameters/idle/TimeScale/scale", 1)
		animation_tree.set("parameters/move/TimeScale/scale", 1)
		animation_tree.set("parameters/sink/TimeScale/scale", 1)
		animation_tree.set("parameters/rise/TimeScale/scale", 1)
...
func update_blend_position(direction: Vector2):
	...
	animation_tree["parameters/sink/BlendSpace2D/blend_position"] = direction
	animation_tree["parameters/rise/BlendSpace2D/blend_position"] = direction
